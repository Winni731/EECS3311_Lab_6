...
//			setupCentiMeterArea();
        ...
        feetArea = new FeetConversionArea(50, 0, 15, 25, centiMeterArea);
        meterArea = new MeterConversionArea(290, 0, 15, 25, centiMeterArea);
...
//			panel.add(feetArea.getTextArea());
    ...
    public void setupFeetArea() {
        feetArea = new FeetConversionArea(50, 0, 240, 240, centiMeterArea);
    }

    public void setupMeterArea() {
        meterArea = new MeterConversionArea(290, 0, 240, 240, centiMeterArea);
    }
